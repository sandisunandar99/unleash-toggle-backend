...
exports.countVariant = exports.count = exports.getVariant = exports.getFeatureToggleDefinitions = exports.getFeatureToggleDefinition = exports.destroy = exports.isEnabled = exports.startUnleash = exports.initialize = exports.Unleash = exports.Strategy = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, events_1.once(unleash, 'synchronized')];
                case 1:
                    _a.sent();
...
function getVariant(name, context, fallbackVariant) {
    if (context === void 0) { context = {}; }
    var variant = fallbackVariant || variant_1.getDefaultVariant();
